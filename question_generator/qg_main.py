...
from question_evaluator import qe_main
...
def get_questions(wiki_text, no_of_questions):
    ...
    # set q_type dictionary
    # which will have questions generated with key q_generators
    # motive is to know which question is generated by what question generator so that we can prioritize
    # questions from question generators with question evaluator

    questions_dict = {}
    questions_dict["is_wh_generator"] = []
    questions_dict["is_generator"] = []
    questions_dict["what_generator"] = []
    questions_dict["when_generator"] = []
    questions_dict["howmany_generator"] = []
    questions_dict["where_generator"] = []
    questions_dict["eo_generator"] = []
    ...
    # passing wiki_text for feedback loop
    question_list = qe_main.evaluate_questions(wiki_text, questions_dict)
...
if __name__ == "__main__":
    with open('/Users/gauravshegokar/Documents/CMU/FALL_2019/NLP/project/Wiki-QA-Magic/data/set1/a2.txt', 'r') as content_file:
